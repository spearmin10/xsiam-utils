                ...
                arraymap(
                    arraymap(
                        arraymap(
                            arraymap(
                                arraymap(
                                    arraycreate(object_create("x", replace("@element", "==", "="))),
                                    object_create(
                                        "x", "@element"->x,
                                        "m", arrayconcat(
                                            regextract("@element"->x, "^=\s*((?:\"(?:\\.|[^\\\"])*\"|(?:\\.|[^\\\"=]))*?)\s*(?:\"(?:\\.|[^\\\"])*\"|(?:\\.|[^\\\"=\s])+)\s*=$"),
                                            regextract("@element"->x, "^=\s*(?:(?:\"(?:\\.|[^\\\"])*\"|(?:\\.|[^\\\"=]))*?)\s*(\"(?:\\.|[^\\\"])*\"|(?:(?:\\.|[^\\\"=\s])+))\s*=$")
                                        )
                                    )
                                ),
                                if(
                                    array_length("@element"->m[]) = 2,
                                    "@element",
                                    object_create(
                                        "x", "@element"->x,
                                        "m", regextract("@element"->x, "^(?:\s*(\"(?:\\.|[^\\\"])*\"|(?:(?:\\.|[^\\\"=])+))\s*=)$")
                                    )
                                )
                            ),
                            if(
                                array_length("@element"->m[]) >= 1,
                                "@element",
                                object_create(
                                    "m", regextract("@element"->x, "^(?:=\s*((?:\"(?:\\.|[^\\\"])*\"|(?:\\.|[^\\\"=]))*?)\s*)$")
                                )
                        ...
                        if(array_length("@element"->m[]) >= 1, "@element", object_create("m", arraycreate("")))
                    ),
                    arrayindex(
                        arraymap(
                            arraycreate(
                                object_create(
                                    "x",
                                    arraymap(
                                        json_extract_scalar_array("@element", "$.m"),
                                        arrayindex(
                                            arraymap(
                                                if(
                                                    "@element" ~= "^\"((?:\\.|[^\"])*)\"$",
